...
r # Shows it's value
```
Output: array([ 16.66666667,  16.66666667,  16.66666667,  16.66666667,
...
r
```
Output: 131 iterations to convergence.  
array([  0.03046998,   0.01064323,   0.07126612,   0.04423198,
         0.        ,   0.02489342,  99.81849527])
I WONDER IF THIS IS GOING TO FORMAT MY HTML CODE FOR ME SIMPLY
